...
- [x] Executar validação funcional do formulário e checagem objetiva de acessibilidade da página `/conteudos` por inspeção publicada de navegação, labels, headings e controles.
...
- [x] Executar checagem objetiva de acessibilidade da página `/conteudos` por inspeção publicada de headings, links, botões, labels e campos de formulário.
...
- [x] Validar no cliente os campos essenciais de Nova Área e Novo Talhão antes do envio, com mensagens claras para identificação, KML e polígono desenhado.
